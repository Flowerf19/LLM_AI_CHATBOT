...
class RelationshipService:
    def __init__(self, llm_service):
        ...
        # Always resolve to src/data
        # Đảm bảo luôn lấy data từ project root
        project_root = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
        self.data_dir = os.path.join(project_root, 'data')
        # Tạo thư mục relationships
        self.relationships_dir = os.path.join(self.data_dir, 'relationships')
    ...
    async def update_server_relationships_summary(self):
        ...
        # LLM sẽ đọc file server_relationships.txt trực tiếp, không cần sinh prompt nội bộ nữa
    ...
    def _build_server_relationships_prompt(self, summary_data: dict) -> str:
        ...
        # Chuẩn hóa: Luôn lấy data/prompts từ project root
        project_root = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
        prompts_dir = os.path.join(project_root, 'data', 'prompts')
        prompt_file = os.path.join(prompts_dir, 'server_relationships_prompt.txt')
